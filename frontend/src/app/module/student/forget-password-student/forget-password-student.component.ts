...
@Component({
    selector: 'app-forget-password-student',
    templateUrl: './forget-password-student.component.html',
    styleUrls: ['./forget-password-student.component.css'],
})
export class ForgetPasswordStudentComponent {
