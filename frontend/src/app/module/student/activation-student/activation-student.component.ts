...
@Component({
  selector: 'app-activation-student',
  templateUrl: './activation-student.component.html',
  styleUrls: ['./activation-student.component.css']
})
export class ActivationStudentComponent implements OnInit {
