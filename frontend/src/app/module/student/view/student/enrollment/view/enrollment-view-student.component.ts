...
@Component({
  selector: 'app-enrollment-view-student',
  templateUrl: './enrollment-view-student.component.html'
})
export class EnrollmentViewStudentComponent implements OnInit {
    ...
    constructor(private service: EnrollmentStudentService, private studentService: StudentStudentService, private courseService: CourseStudentService){
