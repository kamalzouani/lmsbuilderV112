...
export class StudentEditAdminComponent implements OnInit {
    ...
    constructor(private service: StudentAdminService , private categoryService: CategoryAdminService, private instructorService: InstructorAdminService, private courseService: CourseAdminService, @Inject(PLATFORM_ID) private platformId?) {
