...
@Component({
  selector: 'app-module-content-list-admin',
  templateUrl: './module-content-list-admin.component.html'
})
export class ModuleContentListAdminComponent implements OnInit {

    protected fileName = 'ModuleContent';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ModuleContentDto>();
    ...
    public async edit(dto: ModuleContentDto) {
    ...
    public async view(dto: ModuleContentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ModuleContentDto) {
    ...
    public async duplicate(dto: ModuleContentDto) {
    ...
    public exportPdf(dto: ModuleContentDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'module?.id', header: 'Module'},
        ];
    }


    public async loadModule(){
        this.courseModuleService.findAll().subscribe(modules => this.modules = modules, error => console.log(error))
    }


	public initDuplicate(res: ModuleContentDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            //'Module': this.criteria.module?.id ? this.criteria.module?.id : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<ModuleContentDto> {
        return this.service.selections;
    }

    set selections(value: Array<ModuleContentDto>) {
