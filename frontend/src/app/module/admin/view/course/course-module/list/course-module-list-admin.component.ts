...
@Component({
  selector: 'app-course-module-list-admin',
  templateUrl: './course-module-list-admin.component.html'
})
export class CourseModuleListAdminComponent implements OnInit {

    protected fileName = 'CourseModule';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CourseModuleDto>();
    ...
    public async edit(dto: CourseModuleDto) {
    ...
    public async view(dto: CourseModuleDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CourseModuleDto) {
    ...
    public async duplicate(dto: CourseModuleDto) {
    ...
    public exportPdf(dto: CourseModuleDto): void {
...
// add
	...
	public initDuplicate(res: CourseModuleDto) {
        if (res.moduleContents != null) {
             res.moduleContents.forEach(d => { d.courseModule = null; d.id = null; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                ...
                'Order Min': this.criteria.orderMin ? this.criteria.orderMin : environment.emptyForExport ,
                'Order Max': this.criteria.orderMax ? this.criteria.orderMax : environment.emptyForExport ,
    ...
    get selections(): Array<CourseModuleDto> {
        return this.service.selections;
    }

    set selections(value: Array<CourseModuleDto>) {
