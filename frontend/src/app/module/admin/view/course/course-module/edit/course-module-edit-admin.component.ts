...
@Component({
  selector: 'app-course-module-edit-admin',
  templateUrl: './course-module-edit-admin.component.html'
})
export class CourseModuleEditAdminComponent implements OnInit {
