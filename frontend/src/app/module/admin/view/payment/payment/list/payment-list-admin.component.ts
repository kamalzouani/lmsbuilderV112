...
export class PaymentListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PaymentDto>();
    ...
    public async edit(dto: PaymentDto) {
    ...
    public async view(dto: PaymentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PaymentDto) {
    ...
    public async duplicate(dto: PaymentDto) {
    ...
    public exportPdf(dto: PaymentDto): void {
...
// add
    ...
    get selections(): Array<PaymentDto> {
        return this.service.selections;
    }

    set selections(value: Array<PaymentDto>) {
