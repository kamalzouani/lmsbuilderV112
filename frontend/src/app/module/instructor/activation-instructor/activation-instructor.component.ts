...
@Component({
  selector: 'app-activation-instructor',
  templateUrl: './activation-instructor.component.html',
  styleUrls: ['./activation-instructor.component.css']
})
export class ActivationInstructorComponent implements OnInit {
