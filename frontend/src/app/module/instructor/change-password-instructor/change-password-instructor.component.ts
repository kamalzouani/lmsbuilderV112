...
@Component({
  selector: 'app-change-password-instructor',
  templateUrl: './change-password-instructor.component.html',
  styleUrls: ['./change-password-instructor.component.css']
})
export class ChangePasswordInstructorComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/instructor/forget-password'])
    }
