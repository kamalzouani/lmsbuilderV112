...
@Component({
  selector: 'app-instructor-list-instructor',
  templateUrl: './instructor-list-instructor.component.html'
})
export class InstructorListInstructorComponent implements OnInit {

    protected fileName = 'Instructor';
    ...
    constructor( private service: InstructorInstructorService  , private categoryService: CategoryInstructorService, private courseService: CourseInstructorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InstructorDto>();
    ...
    public async edit(dto: InstructorDto) {
    ...
    public async view(dto: InstructorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InstructorDto) {
    ...
    public async duplicate(dto: InstructorDto) {
    ...
    public exportPdf(dto: InstructorDto): void {
...
// add
	...
	public initDuplicate(res: InstructorDto) {
        if (res.courses != null) {
             res.courses.forEach(d => { d.instructor = null; d.id = null; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                'Bio': this.criteria.bio ? this.criteria.bio : environment.emptyForExport ,
                'Expertise': this.criteria.expertise ? this.criteria.expertise : environment.emptyForExport ,
    ...
    get selections(): Array<InstructorDto> {
        return this.service.selections;
    }

    set selections(value: Array<InstructorDto>) {
