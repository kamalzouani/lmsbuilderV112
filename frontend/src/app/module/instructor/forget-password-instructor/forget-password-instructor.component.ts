...
@Component({
    selector: 'app-forget-password-instructor',
    templateUrl: './forget-password-instructor.component.html',
    styleUrls: ['./forget-password-instructor.component.css'],
})
export class ForgetPasswordInstructorComponent {
    ...
    submit() {
        this.authService.sendForgetPasswordActivation(this.forgetPasswordDto.email).subscribe({
            next: () => {
                ...
                this.router.navigate(['instructor/changePassword'])
            },
