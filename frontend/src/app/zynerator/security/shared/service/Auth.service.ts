...
export class AuthService {
    ...
    */
    ...
    public registerInstructor() {
        this.register(this.registerUrl + 'instructor', 'ROLE_INSTRUCTOR', '/instructor/activation')
    }

    public registerStudent() {
        this.register(this.registerUrl + 'student', 'ROLE_STUDENT', '/student/activation')
    }
            ...
            .pipe(
                map(resp => {
                    if (this.user.roleUsers[0].role.authority === 'ADMIN') {
                        ...
                        else if (this.user.roleUsers[0].role.authority === 'INSTRUCTOR') {
                        this.router.navigate(['/instructor/login']);
                        }
                        else if (this.user.roleUsers[0].role.authority === 'STUDENT') {
