...
import java.util.List;
@Service
public class CourseModuleStudentServiceImpl implements CourseModuleStudentService {
    ...
    @Autowired
    private ModuleContentStudentService moduleContentService ;
    @Autowired
    private CourseStudentService courseService ;

    public CourseModuleStudentServiceImpl(CourseModuleDao dao) {
        this.dao = dao;
    }
