...
import ma.zyn.app.service.facade.instructor.course.ModuleContentInstructorService;
...
import ma.zyn.app.service.facade.instructor.course.CourseModuleInstructorService ;
import ma.zyn.app.bean.core.course.CourseModule ;

import java.util.List;
@Service
public class ModuleContentInstructorServiceImpl implements ModuleContentInstructorService {
    ...
    @Autowired
    private CourseModuleInstructorService courseModuleService ;

    public ModuleContentInstructorServiceImpl(ModuleContentDao dao) {
        this.dao = dao;
    }
