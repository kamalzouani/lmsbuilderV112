...
import ma.zyn.app.service.facade.student.course.ModuleContentStudentService;
...
import ma.zyn.app.service.facade.student.course.CourseModuleStudentService ;
import ma.zyn.app.bean.core.course.CourseModule ;

import java.util.List;
@Service
public class ModuleContentStudentServiceImpl implements ModuleContentStudentService {
    ...
    @Autowired
    private CourseModuleStudentService courseModuleService ;

    public ModuleContentStudentServiceImpl(ModuleContentDao dao) {
        this.dao = dao;
    }
