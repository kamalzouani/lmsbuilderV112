...
import java.util.List;
@Service
public class CourseModuleInstructorServiceImpl implements CourseModuleInstructorService {
    ...
    @Autowired
    private ModuleContentInstructorService moduleContentService ;
    @Autowired
    private CourseInstructorService courseService ;

    public CourseModuleInstructorServiceImpl(CourseModuleDao dao) {
        this.dao = dao;
    }
