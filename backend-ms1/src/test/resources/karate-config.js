function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/lmsbuilderv112';
    ...
    config.courseModuleUrl = config.adminUri + 'courseModule/';
    config.instructorUrl = config.adminUri + 'instructor/';
    config.studentUrl = config.adminUri + 'student/';
    config.moduleContentUrl = config.adminUri + 'moduleContent/';
