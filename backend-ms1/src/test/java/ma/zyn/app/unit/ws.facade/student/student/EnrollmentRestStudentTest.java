...
import ma.zyn.app.ws.facade.student.student.EnrollmentRestStudent;
...
public class EnrollmentRestStudentTest {

    private MockMvc mockMvc;

    @Mock
    private EnrollmentStudentServiceImpl service;
    @Mock
    private EnrollmentConverter converter;

    @InjectMocks
    private EnrollmentRestStudent controller;
